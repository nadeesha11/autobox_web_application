            ...
            <section class="content-main  ">
                ...
                <div class="card mx-auto card-login">
                    <div class="card-body ">
                            ...
                            <div class="mb-3 mt-3">
                                <input class="form-control custom" id="password"  name="password"   placeholder="Enter your new password " type="password" />
                                <span id="password_error" class="text-danger">    </span>
                            </div>
                            <div class="mb-3 mt-3 ">
                                <input class="form-control custom" id="password"  name="password_confirmation"  placeholder="Repeat your new password " type="password" />
                                <span  class="mb-3"><p style="font-size: 0.9em !important;">*reqireat least one uppercase,lowercase,number, special character and minimum 6 characters</p>   </span>
