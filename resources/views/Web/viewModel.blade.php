        ...
        <div class="page-header breadcrumb-wrap  mb-10">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="{{ route('web.allads.view') }}">All ads</a>
                    <span></span> <a href="#">Vehicle Types</a>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div style="margin: 13px;" class="product-card"
                                        ...
                                        <div style="  @if ($item->is_top_id == 1) border:#37B093 2px solid !important; @endif  background-color:#00A791 !important;"
                                            ...
                                            <h3 style="color: #fff !important;" class="price">
                    ...
                    <form method="post" action="{{ route('web.filterd_ads.advanced') }}">
                        ...
                        <div class="sidebar-widget price_range range mb-30">
                            ...
                            <div style="margin-bottom: 4px !important;" class="price-filter">
                                <div class="price-filter-inner">
                                    <div>
                                        <input name="title" value="" id="price-range-from" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>

                        <input value="{{ $id }}" name="type" type="hidden">
                        <input value="{{ $viewBrand }}" name="brand" type="hidden">
                        <input value="{{ $viewModel }}" name="model" type="hidden">
